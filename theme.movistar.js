...
var setVars = function(){
	...
	CoreStyle.g.positive = "#8cc238";
	CoreStyle.g.positiveHover = "#85b63a";
	CoreStyle.g.positiveActive = "#98c84c";
	CoreStyle.g.negative = "#c60606";
	CoreStyle.g.negativeHover = "#b90d0d";
	CoreStyle.g.negativeActive = "#cc1f1f";
	CoreStyle.g.subdued = "#75777b";
	CoreStyle.g.subduedHover = "#707276";
	CoreStyle.g.subduedActive = "#838588";
	CoreStyle.g.significant = "#00c6d6";
	CoreStyle.g.significantHover = "#07b9c8";
	CoreStyle.g.significantActive = "#1accda";
